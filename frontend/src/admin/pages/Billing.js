...
function Billing() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-white tracking-tight mb-6">Monthly Billing Summary</h1>
            ...
            {/* Billing Table */}
            <div>
                <h3 className="text-xl font-bold text-white mb-4">Customer Breakdown</h3>
                <Table>
                    <Thead>
                        <Tr>
                            <Th>Customer</Th>
                    ...
                    <Tbody>
                        {billingData.length > 0 ? billingData.map((row, index) => (
                            <Tr key={index}>
                                <Td className="font-semibold text-white">{row.customer}</Td>
                                <Td className="text-right text-[rgba(245,245,245,0.9)]">{row.orders}</Td>
                                <Td className="text-right">
                                    <span className="text-brand-highlight font-medium">{row.litres}</span>
                            ...
                            <Tr>
                                <Td colSpan="4" className="text-center py-10 text-[rgba(245,245,245,0.5)]">
